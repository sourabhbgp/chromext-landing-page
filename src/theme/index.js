export default {
  ...
  colors: {
    ...
    primary: "#0d9896", // primary button and link color
    secondary: "#128a88", // secondary color - can be used for hover states
  ...
  blockTitle: {
    ...
    p: {
      color: "primary",
      fontSize: [0, null, null, null, null, 3],
      lineHeight: 1,
      marginBottom: ["10px", null, null, null, "10px"],
    },
    h2: {
      color: "black",
      fontWeight: "bold",
      fontSize: [5, null, null, null, "32px", null, null, 7],
      lineHeight: [1.24, null, null, null, null, 1.83],
      letterSpacing: ["-1px", null, null, null, null, "-1.5px"],
    },
  },
};
