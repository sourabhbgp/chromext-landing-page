...
const SERVICES_DATA = [
  {
    icon: <FaBolt style={{ color: "#fff", fontSize: 40 }} />,
    title: "Flash Sale Automation",
    text: "With our Advanced Automation Script, buy any Product listed on Flash Sale in seconds.",
  },
  {
    icon: <FaTicketAlt style={{ color: "#fff", fontSize: 40 }} />,
    title: "Auto Apply Coupons",
    text: "We Auto Apply all the Coupons available over Internet, to save your hard earned money.",
  },
  {
    icon: <FaStopwatch style={{ color: "#fff", fontSize: 40 }} />,
    title: "Price Tracking",
    text: "Coming Soon",
  },
  {
    icon: <FaBalanceScale style={{ color: "#fff", fontSize: 40 }} />,
    ...
    <Box sx={styles.services} id="services">
      <Container>
        <BlockTitle
          ...
          title="Meet exciting feature of Extension"
