          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                ...
                <Text as="p">
                  Sometimes, getting some product on Flash Sale could be tedious
                  due to high demand, but with ChromeXT it will going to be very
                  easy process.
                </Text>
              </Box>
              <Box as="ul" sx={styles.list}>
                ...
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  Covered all Flash Sale Products
                </Text>
              </Box>
