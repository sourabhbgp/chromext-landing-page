...
const data = [
  {
    ...
    text: "You can download extension from here or go directly to chrome store and search for chromext. Try it now with more other feature",
  },
  {
    id: 2,
    title: "Select the Product",
    text: "You have to ON the toggle button of product to buy, if product not found, message us. We will add product in less than a hour",
  },
  {
    id: 3,
    title: "Start the Script",
    text: "You can manually start script, also we will automatically start script 2 min before sale. You have full control over when to start script",
  },
  {
    id: 4,
